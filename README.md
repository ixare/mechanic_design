...
- **模拟考试**: 支持按章节、错题或收藏范围随机抽取 30 道选择题和 20 道判断题，限时 20 分钟模拟真实考试环境。
- **综合测试**: 支持按章节、错题或收藏范围对选择题或判断题进行随机抽查。
...
- **意见反馈**: 内置反馈入口，可直接提交 Issue 到 GitHub 或复制反馈内容。
...
- 应用内点击左侧导航栏「意见反馈」按钮，可直接跳转到 GitHub Issues
- 或前往 [Issues 页面](https://github.com/ixare/mechanic_design/issues) 手动提交
